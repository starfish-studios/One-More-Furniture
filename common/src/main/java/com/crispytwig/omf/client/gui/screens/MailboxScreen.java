package com.crispytwig.omf.client.gui.screens;
...
public class MailboxScreen extends AbstractContainerScreen<MailboxMenu> {
    private static final ResourceLocation CONTAINER_LOCATION = new ResourceLocation(OneMoreFurniture.MOD_ID, "textures/gui/mailbox.png");
    ...
    protected void renderLabels(GuiGraphics guiGraphics, int mouseX, int mouseY) {
        ...
        if (data) {
            guiGraphics.blit(
                    new ResourceLocation(OneMoreFurniture.MOD_ID, "textures/gui/excl.png"),
                    x + 21,
                    this.titleLabelY - 2,
                    0,
                    0,
