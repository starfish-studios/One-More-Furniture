...
import com.crispytwig.omf.block.CabinetBlock;
...
public class CabinetBlockEntity extends AbstractDrawerBlockEntity {
    private static final SoundEvent SOUND_OPEN = OMFSoundEvents.CABINET_OPEN.get();
    private static final SoundEvent SOUND_CLOSE = OMFSoundEvents.CABINET_CLOSE.get();

    public CabinetBlockEntity(BlockPos blockPos, BlockState blockState) {
        super(OMFBlockEntities.CABINET.get(), blockPos, blockState);
