...
public class CabinetBlockEntity extends AbstractDrawerBlockEntity {
    private static final SoundEvent SOUND_OPEN = YAFSoundEvents.CABINET_OPEN.get();
    private static final SoundEvent SOUND_CLOSE = YAFSoundEvents.CABINET_CLOSE.get();

    public CabinetBlockEntity(BlockPos blockPos, BlockState blockState) {
        super(YAFBlockEntities.CABINET.get(), blockPos, blockState);
