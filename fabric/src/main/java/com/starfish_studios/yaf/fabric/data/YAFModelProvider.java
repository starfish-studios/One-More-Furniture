...
public class YAFModelProvider extends FabricModelProvider {
    ...
    public YAFModelProvider(FabricDataOutput output) {
        super(output);
    }
    ...
    public void generateBlockStateModels(BlockModelGenerators generators) {
        ...
        YAFBlocks.FLOWER_BASKETS.forEach((omfWoodType, supplier) -> createFlowerBasket(generators, supplier.get()));
        YAFBlocks.CURTAINS.forEach((omfWoodType, supplier) -> createCurtainBlock(generators, supplier.get()));
        YAFBlocks.SOFAS.forEach((omfWoodType, supplier) -> createSofaBlock(generators, supplier.get()));
        ...
        createWindChimeBlock(generators, YAFBlocks.BAMBOO_STRIPPED_WIND_CHIMES.get());
        createWindChimeBlock(generators, YAFBlocks.BONE_WIND_CHIMES.get());
        createWindChimeBlock(generators, YAFBlocks.COPPER_WIND_CHIMES.get());
        createWindChimeBlock(generators, YAFBlocks.ECHO_SHARD_WIND_CHIMES.get());
    ...
    public void generateItemModels(ItemModelGenerators generators) {
        ...
        generators.generateFlatItem(YAFItems.COPPER_SAW.get(), ModelTemplates.FLAT_HANDHELD_ITEM);
    ...
    public static BlockStateGenerator createChairTuckableMultipart(
        ...
        for (Direction direction : Direction.Plane.HORIZONTAL) {
            ...
            for (Map.Entry<ChairType, ResourceLocation> entry : backTypeModels.entrySet()) {
                ...
                ResourceLocation tuckedModel = new ResourceLocation(YetAnotherFurniture.MOD_ID, "block/" + "acacia_chair_" + type.getSerializedName().toLowerCase() + "_tucked");
    ...
    private void createChairTuckableBlock(BlockModelGenerators generators, Block chair) {
        ...
        for (ChairType type : ChairType.values()) {
            ...
            ResourceLocation chairTypeTuckedId = new ResourceLocation(YetAnotherFurniture.MOD_ID, "block/" + chairBaseName + "_" + type.getSerializedName().toLowerCase() + "_tucked");
        ...
        ResourceLocation chairBacklessId = new ResourceLocation(YetAnotherFurniture.MOD_ID, "block/" + chairBaseName + "_backless");
        ...
        ResourceLocation chairBacklessTuckedId = new ResourceLocation(YetAnotherFurniture.MOD_ID, "block/" + chairBaseName + "_backless_tucked");
        ...
        for (ChairType type : ChairType.values()) {
            ResourceLocation chairBackTypeTuckedId = new ResourceLocation(YetAnotherFurniture.MOD_ID, "block/" + chairBaseName + "_" + type.getSerializedName().toLowerCase() + "_tucked");

            if (!generatedModels.contains(chairBackTypeTuckedId)) {
                backTypeModels.put(type, new ResourceLocation(YetAnotherFurniture.MOD_ID, "block/" + chairBaseName + "_" + type.getSerializedName().toLowerCase() + "_tucked"));
