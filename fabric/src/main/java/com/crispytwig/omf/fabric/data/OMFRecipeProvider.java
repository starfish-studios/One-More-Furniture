...
import com.crispytwig.omf.registry.OMFWoodType;
...
public class OMFRecipeProvider extends FabricRecipeProvider {
    public OMFRecipeProvider(FabricDataOutput output) {
        super(output);
    }
    ...
    public void buildRecipes(Consumer<FinishedRecipe> consumer) {
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, OMFItems.COPPER_SAW.get())
        ...
        createWindchime(consumer, OMFItems.AMETHYST_WIND_CHIMES.get(), Items.AMETHYST_SHARD);
        createWindchime(consumer, OMFItems.BAMBOO_WIND_CHIMES.get(), Items.BAMBOO_BLOCK);
        createWindchime(consumer, OMFItems.BAMBOO_STRIPPED_WIND_CHIMES.get(), Items.STRIPPED_BAMBOO_BLOCK);
        createWindchime(consumer, OMFItems.BONE_WIND_CHIMES.get(), Items.BONE);
        createWindchime(consumer, OMFItems.COPPER_WIND_CHIMES.get(), Items.COPPER_INGOT);
        createWindchime(consumer, OMFItems.ECHO_SHARD_WIND_CHIMES.get(), Items.ECHO_SHARD);
