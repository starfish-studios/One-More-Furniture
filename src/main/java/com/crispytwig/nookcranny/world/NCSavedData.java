package com.crispytwig.nookcranny.world;
...
public class NCSavedData extends SavedData {

    public final List<MailboxData> mailboxes = new ArrayList<>();

    public static NCSavedData load(CompoundTag nbt) {
        var data = new NCSavedData();
    ...
    public static NCSavedData getMailboxes(ServerLevel level) {
        return level.getServer().overworld().getDataStorage().computeIfAbsent(NCSavedData::load, NCSavedData::new, NookAndCranny.MOD_ID);
    }
