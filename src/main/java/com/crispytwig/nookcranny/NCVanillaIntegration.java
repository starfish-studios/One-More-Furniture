...
import com.crispytwig.nookcranny.client.renderer.blockentity.TableBlockEntityRenderer;
...
public class NCVanillaIntegration {
    ...
    public static class Client {
        ...
        public static void clientInit() {
            ...
            EntityModelLayerRegistry.registerModelLayer(TableBlockEntityModel.LAYER_LOCATION, TableBlockEntityModel::createBodyLayer);
        ...
        private static void registerRenderers() {
            ...
            BlockEntityRendererRegistry.register(NCBlockEntities.TABLE, TableBlockEntityRenderer::new);
